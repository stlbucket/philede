      ...
      return this.$apollo.mutate({
        ...
        .then(result => {
          ...
          return this.$apollo.mutate({
            ...
            variables: {
              id: this.currentPatch.artifact.id,
  ...
  apollo: {
    loadArtifact: {
      ...
      update (data) {
        ...
        this.currentPatch = this.artifact.patches.nodes[0] || {ddlUp: 'N/A', ddlDown: 'N/A'}
        this.ddlUp = this.currentPatch.ddlUp || 'N/A'
        this.ddlDown = this.currentPatch.ddlDown || 'N/A'
      }
    }
  },
  computed: {
